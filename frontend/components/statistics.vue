                                ...
                                <v-card class="mx-auto" elevation="2" height="200" hover>
                                    <v-card-item>
                                        ...
                                        <div class="d-flex align-center justify-center mt-4">
                                            <span class="text-h2">{{ statisticStore.getStatistics?.visitorCount || 0
                                            }}</span>
                                        </div>
                            ...
                            <v-col cols="12" md="4">
                                <v-card class="mx-auto" elevation="2" height="200" hover>
                                    <v-card-item>
                                        ...
                                        <div class="d-flex align-center justify-center mt-4">
                                            <span class="text-h2">{{ statisticStore.getStatistics?.photoCount || 0
                                            }}</span>
                                        </div>
                                        <div class="text-caption text-center mt-2 text-medium-emphasis">
                                            Yüklenen fotoğraf
                            ...
                            <v-col cols="12" md="4">
                                <v-card class="mx-auto" elevation="2" height="200" hover>
                                    <v-card-item>
                                        ...
                                        <div class="d-flex align-center justify-center mt-4">
                                            <span class="text-h2">{{ statisticStore.getStatistics?.eventCount || 0
                                            }}</span>
                                        </div>
                                        <div class="text-caption text-center mt-2 text-medium-emphasis">
                                            Planlanan etkinlik
                                    ...
                                    <v-card-text>
                                        <v-sheet height="300">
                                            <v-sparkline
                                                ...
                                                :labels="['Fotoğraflar', 'Etkinlikler']" color="primary" type="bar"
                                                auto-draw stroke-linecap="round" line-width="20" padding="16"
                                                show-labels label-size="14"></v-sparkline>
                                        </v-sheet>
                                    </v-card-text>
                                </v-card>
                            </v-col>
                                    ...
                                    <v-card-text>
                                        <v-sheet height="300">
                                            <v-sparkline :value="weeklyVisitorValues"
                                                ...
                                                color="success" gradient fill smooth auto-draw stroke-linecap="round"
                                                line-width="3" padding="16" show-labels label-size="14"></v-sparkline>
                                        </v-sheet>
                                    </v-card-text>
                                </v-card>
                            </v-col>
